...
public class SortedLapseRacerSorterTest {
	...
	@Before public void bef() {
		...
		racer1.addFinishTime(new Time("12.30.00"), 1);
		racer1.addFinishTime(new Time("13.23.34"), 1);
		racer1.addFinishTime(new Time("13.00.00"), 1);
		...
		racer103.addFinishTime(new Time("12.44.00"), 1);
		racer103.addFinishTime(new Time("12.24.00"), 1);
		racer103.addFinishTime(new Time("13.16.07"), 1);
